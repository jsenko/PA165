...
@NamedQuery(name="Team.findTeamByPlayer",
            query="SELECT t FROM Team t, IN(t.players) p WHERE p.id = :player"),
            //query="SELECT t FROM Team t WHERE :player member of t.players"),
            //query="SELECT t FROM Team t JOIN t.players p WHERE :player = p"),
            //query="SELECT t FROM Team t JOIN t.players p WHERE :player = p.id"),
