...
public interface DAO<T> {
     ...
     *
     * @param entity T to be added to the database. Cannot be null.
     * @throws IllegalArgumentException if the argument is null or the entity
     * does not exist.
     */
     ...
     *
     * @return Collection of all entities T in database or empty collection when
     * no T are in the database.
     */
