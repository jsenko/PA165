...
public interface MatchDAO extends DAO<Match> {
     ...
     * @return List of Matches played by home team or empty List when team does
     * not play any home match.
     */
     ...
     * @return List of Matches played by away team or empty List when team does
     * not play any away match.
     */
